 ...
 */
 ...
 if (isset($profile->field_avatar[0])) { 
 	$picture = theme('imagecache', 'thumb', $profile->field_avatar[0]['filepath']);
 } else {
    $picture = '<img src="/sites/all/themes/zenlager/images/avatar-none-150.png" width="150" height="150" />';    	
 }                
