...
/**
 * This file is the Lagervarer customer invoice template for Ubercart.
 */
?>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" bgcolor="#FFFFFF" style="font-family: verdana, arial, helvetica; font-size: small;">
        ...
        <tr valign="top">
          <td>
            ...
            <p><b><?php echo t('Please wait for the seller to contact you'); ?></b><br />
            <?php echo t('The seller should contact you shortly to arrange for payment and delivery of the ordered item(s).'); ?></p>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              <tr>
                <td colspan="2" bgcolor="#ffc90a">
                  <b><?php echo t('Seller Information:'); ?></b>
                </td>
              </tr>
              <tr>
                <td nowrap="nowrap" valign="top">
                  <b><?php echo t('Seller details:'); ?></b>
                </td>
                <td width="98%">
                  [order-seller-company]<br />
                  [order-seller-vat-id]<br />
                  [order-seller-full-name]<br />
                </td>
              </tr>              
              <tr>
                <td nowrap="nowrap">
