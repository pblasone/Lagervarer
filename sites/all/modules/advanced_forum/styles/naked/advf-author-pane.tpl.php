 ...
 */	 
 ...
 if (isset($profile->field_avatar[0])) { 
 	$picture = '<div class="author-pane-line author-image">'.theme('imagecache', 'thumb', $profile->field_avatar[0]['filepath']).'</div>';
 } else {
    $picture = '<div class="author-pane-line author-image"><img src="/sites/all/themes/zenlager/images/avatar-none-150.png" width="150" height="150" /></div>';    	
 }   
 
 $account_name = l($account->name, $account->profile_path);
?>
 ...
 <div class="author-pane-inner">
    <div class="author-pane-name-status author-pane-section">
      ...
      <?php if (!empty($user_title)): ?>
        <div class="author-pane-line author-title"> <?php print $user_title_image . $user_title; ?> 
		<div class="author-points"><?php print $userpoints_points; ?> points</div>
		</div>
      <?php endif; ?>
    ...
    <?php if (!empty($user_stats_ip) || !empty($fasttoggle_block_author) || !empty($troll_ban_author)): ?>		
    ...
    <div class="profile-links author-pane-section">
