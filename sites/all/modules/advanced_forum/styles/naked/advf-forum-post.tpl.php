...
<?php if ($top_post): ?>
  <?php $voting_form = fivestar_widget_form($node); ?>	
...
<?php else: ?>
  ...
  <?php $voting_form = drupal_get_form('fivestarextra_form_comment_'.$comment->cid,'comment',$comment->cid); ?>
